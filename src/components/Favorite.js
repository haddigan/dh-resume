...
const Favorite = () => (
  <div>
    ...
    <ul style={{listStyle: "none"}}>
      ...
      <li>I truly will listen to just about music (as long as it's good). Punk, classical, rap, you name it</li>
      <li>I've been in a weekly bowling league for the past 5 or so years, and I also play golf</li>
    </ul>
  </div>
);
